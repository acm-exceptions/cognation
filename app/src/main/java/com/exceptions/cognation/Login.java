...
import com.exceptions.cognation.custom.CustomActivity;
import com.exceptions.cognation.model.ChatUser;
import com.exceptions.cognation.utils.Utils;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            ChatFragment.user = new ChatUser(task.getResult().getUser().getUid(),task.getResult().getUser().getDisplayName(), task.getResult().getUser().getEmail(),true,defaultRoom);
                            startActivity(new Intent(Login.this, ChatFragment.class));
                            finish();
                        }
